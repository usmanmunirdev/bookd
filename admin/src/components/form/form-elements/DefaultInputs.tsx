        ...
        <div>
          ...
          <div className="relative w-full flatpickr-wrapper">
            <Flatpickr
              ...
              placeholder="Select an option"
              className="h-11 w-full rounded-lg border appearance-none px-4 py-2.5 text-sm shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-3  dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30  bg-[#f3f5f8] text-gray-800 border-gray-300 focus:border-[#467ff7] focus:ring-[#467ff7]/20 dark:border-gray-700 dark:focus:border-[#467ff7]"
            />
