    ...
    >
      <span className="relative">
        ...
        <span
          ...
          style={{
            backgroundColor: !document.documentElement.classList.contains('dark') && checked ? '#467ff7' : undefined,
            borderColor: !document.documentElement.classList.contains('dark') && checked ? '#467ff7' : undefined
          }}
        >
          {/* Inner Dot */}
          <span
